<?php include('partials-front/menu.php'); ?>
    ...
    <section class="categories">
        <div class="container">
            ...
            <?php 
                //creaet SQL query to display categories from Database
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php
             ...
             //getting food from database that are active or feature
             //SQL query
             ...
             if($count2>0)
             {
                ...
                while ($row2 = mysqli_fetch_assoc($res2))
                {
                   ...
                   <div class="food-menu-img">
                    <?php
                        //check whether image availablke or not
                        if($image_name=="")
                        {
                            //image not available
                            echo "<div class='error'>Image not available</div>";        
